 ...
 * @LastEditTime: 2022-02-22 15:13:27
 * @LastEditors: qiulei
 * @Description: 
 * @FilePath: /src2src/kernel/test-origin.cpp
 */
// Verilated -*- C++ -*-
...
VL_INLINE_OPT void VSimTop::_sequent__TOP__56(VSimTop__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->SimTop__DOT__l_soc__DOT__core_with_l2__DOT__core__DOT__exuBlocks_1__DOT__scheduler__DOT__rs_1__DOT__rs_0__DOT__payloadArray__DOT__wenVec_7_0) {
