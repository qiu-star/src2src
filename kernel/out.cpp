 ...
 * @LastEditTime: 2022-02-26 18:21:01
 * @LastEditors: qiulei
 * @Description: 
 * @FilePath: /src2src/kernel/out.cpp
 */
// Verilated -*- C++ -*-
...
VL_INLINE_OPT void VSimTop::_sequent__TOP__56(VSimTop__Syms* __restrict vlSymsp) {
    ...
    } else {vlTOPp->SimTop__DOT__l_soc__DOT__core_with_l2__DOT__core__DOT__exuBlocks__DOT__fuBlock__DOT__exeUnits_3__DOT__csr__DOT__cfgMerged___05F1 = ((IData)(vlTOPp->SimTop__DOT__l_soc__DOT__core_with_l2__DOT__core__DOT__exuBlocks__DOT__fuBlock__DOT__exeUnits_3__DOT__csr__DOT___T_269) 
